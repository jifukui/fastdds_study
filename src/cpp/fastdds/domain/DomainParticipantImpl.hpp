        ...
        namespace fastdds
        {
                namespace dds
                {
                        ...
                        protected:
                                ...
                                //! Pre-calculated guid 预计算guid
                                fastrtps::rtps::GUID_t guid_;

                                //! For instance handle creation 下一个实例的ID
                                uint32_t next_instance_id_;

                                //! Participant Qos 域的qos
                                DomainParticipantQos qos_;

                                //! RTPSParticipant rtps参与者
                                fastrtps::rtps::RTPSParticipant *rtps_participant_;

                                //! Participant* 域参与者
                                DomainParticipant *participant_;

                                //! Participant Listener 监听器
                                DomainParticipantListener *listener_;

                                //! Publisher maps 发布者map
